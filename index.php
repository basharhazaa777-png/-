...
// تصدير حالة المسؤول إلى بيئة JavaScript
...
<body>
    ...
    <div style="padding: 40px; text-align: center;">
        ...
        <p style="color: var(--text-muted);">هذه الواجهة مخصصة لاستعراض الكتب المتاحة لقسم مدرسة الحاسوب بباجل.</p>
    </div>
        ...
        <div class="hub-header">
            ...
            <div>
                <button onclick="window.location.href='?action=logout'" style="background-color: #d32f2f; color: white; border: none; padding: 8px 15px; border-radius: 5px; cursor: pointer;">
                    <i class="fas fa-sign-out-alt"></i> قفل الجلسة والlogout
                </button>
    ...
    /* 3. منطق جافا سكريبت المطور لإدارة الحالة وثبات الواجهة */
    <script>
