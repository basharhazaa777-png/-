<?php
// ==========================================
// محرك الأمان الخلفي المطور لـ م. بشار صغير
// ==========================================
...
<body>
    ...
    <div id="splash">
        <div class="splash-box">
            ...
            <p style="font-size: 13px; color: #666; margin: 12px 0 25px; line-height: 1.6;">l;مكتبة سحابية متكاملة لإدارة واستعراض المقررات الأكاديمية وملفات الـ PDF الحقيقية للطلاب.</p>
            ...
            <div style="font-size: 11px; color: #a0a0a0; margin-top: 18px; font-weight: bold;">2026الحقوق المحفوظة</div>
        </div>
    </div>
    ...
    <script>
        ...
        // استلام حالة التحقق الأمني الموثق مباشرة من سيرفر الـ PHP المطور
        ...
        const App = {
            init: () => { 
                ...
                // فتح اللوحة تلقائياً بعد إعادة التوجيه الناجح من السيرفر لراحة المسؤول
        ...
        const UI = {
            ...
            // التعديل هنا: عند الضغط على المسؤول يتم فحص الجلسة سحابياً، وإذا لم يكن مسجلاً تفتح نافذة الـ PHP فوراً
            triggerHubWithAuth: () => {
                if (isAdminAuthenticated) {
                    UI.openHubPanel();
                } else {
            ...
            // تم تنظيف الدوال من جافاسكربت لتعتمد على التوثيق الموحد المسبق
            openGate: (gateName) => {
            ...
            // قفل الجلسة عبر خادم الـ PHP لإنهائها نهائياً من السيرفر السحابي
            lockAdmin: () => { 
